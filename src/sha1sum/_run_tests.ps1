# Comprehensive test suite for sha1sum.c
$ErrorActionPreference = 'Continue'
$exe = Join-Path $PSScriptRoot 'sha1sum.exe'
$PASS = 0
$FAIL = 0
...
$ABC_HEX = 'a9993e364706816aba3e25717850c26c9cd0d89d'
$EMPTY_HEX = 'da39a3ee5e6b4b0d3255bfef95601890afd80709'
$BAD_HEX = '0000000000000000000000000000000000000000'
$TAG = 'SHA1'
...
$r = RunExe '--version'; check (($r.ExitCode -eq 0) -and ($r.StdOut -match 'sha1sum')) 'version'
