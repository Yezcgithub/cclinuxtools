# Comprehensive test suite for sha224sum.c
$ErrorActionPreference = 'Continue'
$exe = Join-Path $PSScriptRoot 'sha224sum.exe'
$PASS = 0
$FAIL = 0
...
$ABC_HEX = '23097d223405d8228642a477bda255b32aadbce4bda0b3f7e36c9da7'
$EMPTY_HEX = 'd14a028c2a3a2bc9476102bb288234c415a2b01f828ea62ac5b3e42f'
$BAD_HEX = '00000000000000000000000000000000000000000000000000000000'
$TAG = 'SHA224'
...
$r = RunExe '--version'; check (($r.ExitCode -eq 0) -and ($r.StdOut -match 'sha224sum')) 'version'
